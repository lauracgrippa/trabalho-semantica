...
\infrule[BS-MatchList1]{\env \vdash e  \Downarrow  \NIL \andalso \env \vdash e_1  \Downarrow v}{\env \vdash \MATCH \ e \ \WITH\\ \NIL \Rightarrow e_1 \\ \sintaxe{|}\  x\sintaxe{::} xs \Rightarrow \ e_2 \Downarrow v}

\infrule[BS-MatchList2]{\env \vdash e  \Downarrow \ v\sintaxe{::} vs \andalso \env, x \mapsto v \sintaxe{;} xs \vdash vs \andalso \vdash e_2 \Downarrow v}{\env \vdash \MATCH \ e \ \WITH\\ \NIL \Rightarrow e_1 \\ \sintaxe{|}\  x\sintaxe{::} xs \Rightarrow \ e_2 \Downarrow v}
...
\infrule[BS-MatchMaybe]{\env \vdash e_1 \Downarrow \MAYBE  \andalso \env, ~ x\mapsto e_3}{\env \vdash \MATCH \ e_1 \ \WITH\\ \NOTHING  \Rightarrow e_2 \\ \sintaxe{|}\ \JUST ~ x \Rightarrow \ e_3}
...
\infrule[BS-MatchEither]{\env \vdash e_1 \Downarrow \EITHER  \andalso \env, x\mapsto e_2 \andalso \env, y\mapsto e_3}{\env \vdash \MATCH \ e_1 \ \WITH\\ \sintaxe{|} ~ \LEFT  ~  x \Rightarrow e_2 \\ \sintaxe{|}\ \RIGHT ~ y \Rightarrow \ e_3}
